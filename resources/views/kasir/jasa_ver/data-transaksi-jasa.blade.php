...
@section('content')
    <div class="container-fluid">
        <a href="{{ route('transaksi-jasa.create') }}" class="btn btn-outline-dark mb-3"><i class="fa fa-plus ">
        </i> Tambah</a>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                                    ...
                                    @foreach ($transaksis as $index => $transaksi)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                <a href="{{route('transaksi-jasa.detail-transaksi',$i)}}"
                                                    class="btn btn-sm btn-outline-warning mb-3"><i class="fa fa-info-circle ">
                                                    </i> Detail
                                                </a>
                                                <a href="{{route('transaksi-jasa.cetak-transaksi',$i)}}"
