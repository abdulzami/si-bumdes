...
@section('content-header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Tambah Jenis Usaha</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Tambah Jenis Usaha <div class="badge badge-info"></div>
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('jenis-usaha.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Wujud Usaha</label>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" value="Produk"
                                            id="customRadio1" name="wujud_usaha">
                                        <label for="customRadio1" class="custom-control-label">Produk</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" value="Jasa" id="customRadio2"
                                            name="wujud_usaha">
                                        <label for="customRadio2" class="custom-control-label">Jasa</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Kepala Usaha</label>
                                    <input type="text" class="form-control" name="kepala_usaha"
                                        placeholder="Masukkan Nama Kepala Usaha">
                                </div>
                                <div class="form-group">
