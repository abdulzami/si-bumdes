        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Laporan Laba Rugi Produk</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <a href="{{ route('laporan-labarugi-produk.print') }}" class="btn btn-outline-primary mb-3"><i class="fa fa-print ">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('laporan-labarugi-produk.filter-print') }}" method="POST">
                        @csrf
                        <div class="form-row">
