...
@section('content-header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Tambah Kasir Usaha <span class="badge badge-info">{{$jenis_usaha->name}}</span></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Tambah Kasir<div class="badge badge-info"></div>
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('kasir.store',$id_jenis_usaha) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
