...
@section('content-header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Tambah Pengeluaran Beban Gaji </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('login') }}">Home</a></li>
                    <li class="breadcrumb-item active"><a href="{{ route('beban-gaji') }}">Pengeluaran Beban Gaji</a></li>
                    <li class="breadcrumb-item active">Tambah Pengeluaran Beban Gaji</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Tambah Beban Gaji<div class="badge badge-info"></div>
                    </h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{route('beban-gaji.store')}}">
                        @csrf
                        <div class="form-group">
                            <label for="inputAddress">Nama Beban Gaji</label>
                            <input type="text" class="form-control" name="nama_beban_gaji" placeholder="Masukkan Nama Beban Operasional">
                        </div>
                        <div class="form-group">
                            <label>Kasir</label>
                            <select class="form-control" name="kasir">
                              ...
                              <option value="{{Crypt::encryptString($kasirnya->id)}}">{{$kasirnya->name}}</option>
                              @endforeach
                            </select>
                          </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="total_gaji" id="masking2" class="form-control" placeholder="Masukkan Total Gaji" aria-label="Username" aria-describedby="basic-addon1">
                              </div>
                        </div>
                        <div class="form-group">
